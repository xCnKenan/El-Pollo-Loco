...
class Mainscreen {
  ...
  screenCanvas;
  ctxStartScreen;
  background = new Backgroundimage('img/9_intro_outro_screens/start/startscreen_1.png', 0, 0);
  ...
  showOnScreen(elements){
    this.ctxStartScreen.drawImage(elements.img, elements.x, elements.y, elements.height, elements.width);
  }
}
